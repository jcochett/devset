...
check_files "$SOURCE_DIR_COLORS" "$SOURCE_DIR_COLORS" "${FILES_COLOR[@]}"
check_files "$SOURCE_DIR_COMPILER" "$SOURCE_DIR_COMPILER" "${FILES_COMPILER[@]}"
check_files "$SOURCE_DIR_CHARTAB" "$SOURCE_DIR_CHARTAB" "${FILES_CHARTAB[@]}"
check_files "$SOURCE_DIR_VIMHELP" "$SOURCE_DIR_VIMHELP" "${FILES_VIMHELP[@]}"
check_files "$SOURCE_DIR_VIMRC" "$SOURCE_DIR_VIMRC" "${FILES_VIMRC[@]}"
